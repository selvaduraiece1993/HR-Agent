    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
      <div className={`relative ${!hasCredits ? 'opacity-60' : ''}`}>
        <Link href={hasCredits ? '/recruiter/dashboard/create-interview' : '#'}>
          <div
            className={`bg-white border border-gray-200 rounded-lg p-5 shadow-sm ${hasCredits ? 'cursor-pointer hover:shadow-md transition-shadow' : 'cursor-not-allowed'}`}
          >
            <div className="flex items-center justify-between mb-3">
              <Video className="p-2 text-teal-600 bg-teal-50 rounded-lg h-12 w-12" />
              {!hasCredits && (
                <div className="flex items-center gap-2 text-orange-600 bg-teal-50 px-3 py-1 rounded-full">
            ...
            <div className="flex items-center gap-2 text-sm">
              ...
              <span className="text-teal-600 font-medium">Cost: 1 Credit</span>
            </div>
          </div>
        </Link>
        {!hasCredits && (
      ...
      <div className="bg-white border border-gray-200 rounded-lg p-5 shadow-sm">
        <Phone className="p-2 text-teal-600 bg-teal-50 rounded-lg h-12 w-12" />
