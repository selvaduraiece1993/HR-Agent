...
function InterviewDetailContainer({ interviewDetail }) {
  ...
  const parsedQuestions = (() => {
    const raw = interviewDetail?.question_list;
    ...
    <>
      <div className="p-5 bg-white border rounded-xl shadow-sm mt-5">
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-xl font-bold">{interviewDetail?.job_position}</h2>
          <Button
            variant="outline"
            size="sm"
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              <strong>{interviewDetail?.job_position}</strong>? This action
