...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-teal-50 to-teal-50 flex flex-col">
      {/* Main Content */}
      <div className="flex flex-1 flex-col lg:flex-row">
        ...
        <div className="w-full lg:w-1/2 flex flex-col justify-center px-8 py-12 md:px-12 lg:px-16 xl:px-24 space-y-8">
          <div className="flex items-center space-x-3">
            ...
            <h1 className="text-4xl font-bold bg-gradient-to-r from-teal-600 to-teal-600 bg-clip-text text-transparent tracking-tight">
              AI Recruiter Pro
            </h1>
          </div>

          <h2 className="text-3xl font-semibold text-gray-900 leading-tight">
            Transform Your <span className="text-teal-600">Hiring Process</span>{' '}
            with AI
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
            <div className="flex items-start space-x-3 p-4 bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow">
              <ShieldCheck className="h-5 w-5 text-teal-500 mt-0.5 shrink-0" />
              <div>
            ...
            <div className="flex items-start space-x-3 p-4 bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow">
              <Clock className="h-5 w-5 text-teal-500 mt-0.5 shrink-0" />
              <div>
            ...
            <div className="flex items-start space-x-3 p-4 bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow">
              <BarChart2 className="h-5 w-5 text-teal-500 mt-0.5 shrink-0" />
              <div>
          ...
          <div className="mt-6 flex items-center space-x-4">
            <div className="flex -space-x-2">
              {[1, 2, 3, 4].map((item) => (
                <div
                  key={item}
                  className="h-10 w-10 rounded-full bg-teal-100 border-2 border-white"
                />
              ))}
            </div>
            <div>
        ...
        {/* Right Side */}
        <div className="w-full lg:w-1/2 flex items-center justify-center px-8 py-12 lg:px-12 lg:py-24 bg-gradient-to-br from-teal-600 to-teal-700">
          <div className="w-full max-w-md bg-white rounded-2xl shadow-xl overflow-hidden">
            <div className="p-10 text-center">
              ...
              <Button
                ...
                className="w-full py-3 px-4 inline-flex justify-center items-center gap-3 rounded-xl font-medium text-white bg-teal-600 hover:bg-amber-700 transition-colors shadow-sm cursor-pointer "
              >
                <Image
                  src="/googleicon.png"
                  alt="Google"
