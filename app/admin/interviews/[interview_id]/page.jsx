...
export default function InterviewDetailPage() {
  ...
  const fetchDetails = async () => {
    ...
    const resultsTableName= process.env.INTERVIEW_RESULTS_TABLE_NAME;
      ...
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center gap-2">
            ...
            {interview.job_position || interview.name || 'Untitled Interview'}
          </CardTitle>
          <CardDescription>
        ...
        <CardContent className="space-y-2">
          <div><span className="font-semibold">Description:</span> {interview.job_description || 'No description provided.'}</div>
