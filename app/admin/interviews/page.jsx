...
function InterviewAnalytics() {
  ...
  const getStatusColor = (interview) => {
    if (interview.completedCount > 0) return 'text-teal-600 bg-teal-50';
    if (interview.candidateCount > 0) return 'text-teal-600 bg-teal-50';
              ...
              {filteredInterviews.map((interview) => (
                <div key={interview.interview_id} className="relative">
                  <Link
                    ...
                    className="block"
                  >
                    <div className="flex items-center justify-between p-4 border rounded-lg hover:bg-teal-50 transition-colors cursor-pointer">
                      <div className="flex items-center space-x-4">
                        ...
                        <div>
                          <h3 className="font-medium text-gray-900">
                            {interview.title || interview.name || interview.job_position || interview.job_description || 'Untitled Interview'}
                          </h3>
      ...
      <AlertDialog open={showDeleteAlert} onOpenChange={setShowDeleteAlert}>
        <AlertDialogContent>
          ...
          <AlertDialogFooter>
            ...
            <AlertDialogAction onClick={confirmDeleteInterview} className="bg-orange-600 hover:bg-orange-700">Delete</AlertDialogAction>
          </AlertDialogFooter>
        </AlertDialogContent>
      </AlertDialog>
    </div>
